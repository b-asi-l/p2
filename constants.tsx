...
export const Icons = {
  ...
  Trips: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 20a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z"/><path d="M10 2v20"/><path d="M2 7h20"/><path d="M2 12h20"/><path d="M2 17h20"/></svg>
  ),
  User: () => (
...
export const MOCK_USER: any = {
  ...
  vehicle: 'Tesla Model 3 / Yamaha R1',
  rating: 4.9,
  tripsCount: 42
};
...
export const MOCK_TRIPS: any[] = [
  {
    ...
    pricePerSeat: 5,
    status: 'OPEN',
    description: 'Daily commute. Looking for friendly co-travelers to share the morning ride and fuel costs.',
    requests: []
  },
  {
    id: 't2',
    ...
    ownerAvatar: 'https://picsum.photos/seed/james/150/150',
    from: 'Riverside Apt',
    to: 'City Center Mall',
    date: '2024-05-20',
    time: '10:00 AM',
    ...
    pricePerSeat: 3,
    status: 'OPEN',
    description: 'Quick ride to the mall. Bike gear provided if needed.',
    requests: []
  }
];
